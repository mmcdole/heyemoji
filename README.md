...
The `heyemoji` is a slack reward system that allows team members to recognize eachother.  This is done by mentioning a user's slack name in a channel along with one of the pre-configured reward emoji.
